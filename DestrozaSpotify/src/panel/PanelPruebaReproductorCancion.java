...
//	private JButton btnAleatorio;
	...
	public PanelPruebaReproductorCancion(VistaPrincipal v, GestionDeLaInformacion gestionINF) {
		...
		btnPlay.setBounds(546, 613, 52, 52);
		add(btnPlay);
		...
		btnPause.setFont(new Font("Dialog", Font.BOLD, 16));
		btnPause.setBorderPainted(false);
		btnPause.setBackground(new Color(63, 61, 61));
		btnPause.setBounds(546, 613, 52, 52);
		add(btnPause);
...
//						System.out.println("no anuncio");
		...
		btnAnterior.setBounds(486, 613, 52, 52);
		add(btnAnterior);
...
//						System.out.println("No Premiun");
		...
		btnSiguente.setBounds(607, 613, 52, 52);
		add(btnSiguente);
		...
		btnBucle.setFont(new Font("Dialog", Font.PLAIN, 16));
		btnBucle.setBorderPainted(false);
		btnBucle.setBackground(new Color(53, 53, 53));
		btnBucle.setBounds(424, 613, 52, 52);
		add(btnBucle);
		...
		*/
		...
		btnFavoritos.setBounds(668, 613, 52, 52);
		add(btnFavoritos);
